...
namespace Homework_4._4
{
   internal class ClassFor1DArray
   {
      ...
      public static void ComparisonValue(int a, int b, int c)
      {
         ...
         if (b > a && b > c)
         {
            Console.WriteLine("Отрицательных элементов Больше отрицательных элементов в массиве B");
         }
         if (c > a && c > b)
         {
            Console.WriteLine("Отрицательных элементовБольше отрицательных элементов в массиве C");
         }
      }
